...
def convert_to_cnn(content, vocab, args):
    ...
    sample = {"cnn_input_ids": words_line}
    return sample


def convert_to_unsup_cnn(ori, aug, vocab, args):
    pad_size = args.train_max_seq_length
    ...
    sample = {"cnn_ori_input_ids": words_line_ori,
              "cnn_aug_input_ids": words_line_aug}
    return sample
